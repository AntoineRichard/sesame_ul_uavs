...
#include "sesame_ul_uavs/gazebo_ros_p3d_v2.h"
...
namespace gazebo
{
GZ_REGISTER_MODEL_PLUGIN(GazeboRosP3Dv2);

////////////////////////////////////////////////////////////////////////////////
// Constructor
GazeboRosP3Dv2::GazeboRosP3Dv2()
{
}
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void GazeboRosP3Dv2::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  // Get the world name.
  ...
  this->callback_queue_thread_ = boost::thread(
    boost::bind(&GazeboRosP3Dv2::P3DQueueThread, this));

  // New Mechanism for Updating every World Cycle
  // Listen to the update event. This event is broadcast every
  // simulation iteration.
  this->update_connection_ = event::Events::ConnectWorldUpdateBegin(
      boost::bind(&GazeboRosP3Dv2::UpdateChild, this));
}

////////////////////////////////////////////////////////////////////////////////
// Update the controller
void GazeboRosP3Dv2::UpdateChild()
{
#ifdef ENABLE_PROFILER
  IGN_PROFILE("GazeboRosP3Dv2::UpdateChild");
#endif
  if (!this->link_)
    return;
  ...
  if (this->pub_.getNumSubscribers() > 0)
  {
	...
	std::string tmp_link_name;
  	tmp_link_name = tf::resolve(prefix, this->link_name_);
        this->pose_msg_.child_frame_id = tmp_link_name;
...
double GazeboRosP3Dv2::GaussianKernel(double mu, double sigma)
{
...
void GazeboRosP3Dv2::P3DQueueThread()
{
